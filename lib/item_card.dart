...
class ItemCard extends StatefulWidget {
   ItemCard(this.institute, this.onTap,{Key? key}) : super(key: key);
DummyData institute;
Function()? onTap;
  @override
    ...
    child: InkWell(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(widget.institute.institute!,
         ...
         // Text(widget.institute.!, style: TextStyle(fontWeight:  FontWeight.normal, fontSize: 18.0, color: Colors.grey,
         // ),
         //   overflow: TextOverflow.ellipsis,
         // )
         //  ],
